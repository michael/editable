...
- Save policy: structural commands and keyboard/paste/drag actions are prevented during translation editing; unexpected structural changes are rejected by the server without losing the draft; text and supported formatting save successfully; undo does not cross languages.
